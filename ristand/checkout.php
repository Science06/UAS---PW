		...
		<div class="container">
			<div class="w3_footer_grids">
				...
				<div class="col-md-3 w3_footer_grid">
					<h3>Tentang Kami</h3>
					<ul class="info"> 
						<li><i class="fa fa-arrow-right" aria-hidden="true"></i><a href="pr.html">About Us "Kelompok 5"</a></li>
						<li><i class="fa fa-arrow-right" aria-hidden="true"></i><a href="pr.html">How To</a></li>
						<li><i class="fa fa-arrow-right" aria-hidden="true"></i><a href="pr.html">FAQ</a></li>
					</ul>
				</div>
				<div class="clearfix"> </div>
			</div>
