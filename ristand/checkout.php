...
<html>
<head>
<title>Ristand - Checkout</title>
<!-- for-mobile-apps -->
<meta name="viewport" content="width=device-width, initial-scale=1">
<meta http-equiv="Content-Type" content="text/html; charset=utf-8" />
<meta name="keywords" content="Ristand, Kelompok 5" />
	...
	<div class="logo_products">
		...
		<div class="w3ls_logo_products_left1">
				<ul class="phone_email">
					<li><i class="fa fa-phone" aria-hidden="true"></i>Hubungi Kami : (+628)999 205 313</li>
				</ul>
			</div>
			<div class="w3ls_logo_products_left">
				<h1><a href="index.php">Ristand</a></h1>
			</div>
...
<!-- checkout -->
	<div class="checkout">
		<div class="container">
			<h1>Terima kasih, <?=$_SESSION['name']?> telah membeli <?php echo $itungtrans3 ?> barang di Ristand</span></h1>
			...
			<hr>
			<br><center>
			<h2>Total harga yang tertera di atas sudah termasuk ongkos kirim sebesar Rp5.000</h2>
		...
		<br>
        <br>
        <p>Orderan anda Akan Segera kami proses 1x10 Menit Setelah Anda Melakukan Pembayaran ke ATM kami dan menyertakan informasi pribadi yang melakukan pembayaran seperti Nama Pemilik Rekening / Sumber Dana, Tanggal Pembayaran, Metode Pembayaran dan Jumlah Bayar.</p>
...
<div class="footer">
		<div class="container">
			<div class="w3_footer_grids">
				<div class="col-md-4 w3_footer_grid">
					...
					<ul class="address">
						<li><i class="glyphicon glyphicon-map-marker" aria-hidden="true"></i>Elia, Fransiska, Neziah</li>
						<li><i class="glyphicon glyphicon-earphone" aria-hidden="true"></i>+62 899 9205 313</li>
					</ul>
				</div>
				<div class="col-md-3 w3_footer_grid">
					<h3>Tentang Kami</h3>
					<ul class="info"> 
						<li><i class="fa fa-arrow-right" aria-hidden="true"></i><a href="index.html">About Us "Kelompok 5"</a></li>
						<li><i class="fa fa-arrow-right" aria-hidden="true"></i><a href="index.html">How To</a></li>
						<li><i class="fa fa-arrow-right" aria-hidden="true"></i><a href="index.html">FAQ</a></li>
					</ul>
				</div>
				<div class="clearfix"> </div>
			</div>
		...
		<div class="footer-copy">
			...
			<div class="container">
				<p>© 2022 Kelompok 5 All rights reserved</p>
			</div>
		</div>
